...
import 'package:clickshoppy/Provider/Favourite/UpdateFavProvider.dart';
import 'package:clickshoppy/Provider/NotificationProvider.dart';
...
import 'package:clickshoppy/Provider/explore_provider.dart';
import 'package:clickshoppy/Provider/authenticationProvider.dart';
import 'package:clickshoppy/Provider/myWalletProvider.dart';
import 'package:clickshoppy/Provider/paymentProvider.dart';
import 'package:clickshoppy/Screen/SplashScreen/Splash.dart';
...
import 'package:clickshoppy/cubits/personalConverstationsCubit.dart';
import 'package:clickshoppy/repository/brandsRepository.dart';
import 'package:clickshoppy/repository/chatRepository.dart';
...
print("--------------------- main, kReleaseMode : ${kReleaseMode}");
  if (kReleaseMode) {
  ...
  print("----------------- prefs.getString(APP_THEME) : ${prefs.getString(APP_THEME)}");

  HttpOverrides.global = MyHttpOverrides();
  print("---------------------- HttpOverrides.global : ${HttpOverrides}");
...
Future<void> initializedDownload() async {
  print("/////////////////////// enter in FlutterDownloader.initialize");
