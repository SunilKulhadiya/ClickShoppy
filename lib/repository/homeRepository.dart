...
class HomeRepository {
  ...
  static Future<Map<String, dynamic>> fetchCategories(
    ...
    try {
      ...
      print("??????????????????????????????? homeRepository.dart---------------, fetchCategories, categoryData : ${categoryData}");
...
print("########################### homeRepository.dart, fetchSections, sectionData : ${sectionData}");
      return {
...
print("/////////////////////////// homeRepository.dart, fetchMostLikeOrFavouriteProducts, ------------- mostLikeProductData : ${mostLikeProductData}");
      return {
