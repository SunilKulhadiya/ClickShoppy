...
import 'package:clickshoppy/Screen/Product%20Detail/Widget/productExtraDetail.dart';
import 'package:clickshoppy/Screen/Product%20Detail/Widget/statesticsAnimatedHighlightWidget.dart';
import 'package:clickshoppy/cubits/appSettingsCubit.dart';
import 'package:clickshoppy/main.dart';
import 'package:clickshoppy/widgets/star_rating.dart';
...
import 'package:clickshoppy/Provider/CartProvider.dart';
import 'package:clickshoppy/Provider/UserProvider.dart';
...
/*     _controller1.addListener(
  ...
  UpdateCurrency(BuildContext context) {
    // if (SysCurrency == "usd") {
    Future.delayed(Duration(seconds: 00), () async {
      context
          .read<SystemProvider>()
          .getCurrency(curLng: getTranslated(context, 'CurrentLanguage'))
          .then((systemConfigData) async {
        setState(() {
          SysCurrency = systemConfigData;
          SysLanguage = getTranslated(context, 'CurrentLanguage');
        });
      });
    });
    // }
  ...
  Widget build(BuildContext context) {
    ...
    if(SysLanguage != getTranslated(context, 'CurrentLanguage'))
      UpdateCurrency(context);
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Stack(
                      children: [
                        Container(
                          child : sliderList[index] != 'youtube'
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  widget.model!.brandName != '' &&
                                      ...
                                      : const SizedBox(),
                                  GetTitleWidget(
                                    title: getTranslated(context, 'CurrentLanguage') == 'English' ?
                                      widget.model!.name! : widget.model!.motherTongue == null ? "" :
                                      widget.model!.motherTongue!,
                                  ),
                            ...
                            getvariantPart(),
                            getDivider(2, context),
                            context.read<PromoCodeProvider>()
                                    .promoCodeList
                                    .isNotEmpty
                                ? SaveExtraWithOffers(
                                    update: update,
...
//widget.model!.attributeList![index].name_MT
  getvariantPart() {
        ...
        ? Container(
            ...
            child: Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  List<Widget?> chips = [];
                  List<String> att = getTranslated(context, 'CurrentLanguage') == 'English' ?
                      widget.model!.attributeList![index].value!.split(',') :
                      widget.model!.attributeList![index].value_MT!.split(',');
                  List<String> attId =
                  ...
                  // print("44444444444444444444 4444444 4 ==>> productDetail.dart, value : ${value}");
                  // print("44444444444444444444 4444444 4 ==>> productDetail.dart, att[_selectedIndex[index]!] : ${att[_selectedIndex[index]!]}");
                  // print("44444444444444444444 4444444 4 ==>> productDetail.dart, getTranslated(context, 'VAR_SEL').length) : ${getTranslated(context, 'VAR_SEL').length}");
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text(getTranslated(context, 'CurrentLanguage') == 'English' ?
                                    '${widget.model!.attributeList![index].name!} : $value' :
                                    '${widget.model!.attributeList![index].name_MT!} : $value',
                                    style: const TextStyle(
                                      fontFamily: 'ubuntu',
                                      fontWeight: FontWeight.bold,
                                    ),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        productList[index].name! : productList[index].motherTongue == null ? "" :
                        productList[index].motherTongue!,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('${price.toString()+ " "+SysCurrency}',
                                      ...
                                      children: <Widget>[
                                        Text(
                                          double.parse(productList[index]
                                                      .prVarientList![0]
                                                      .disPrice!) != 0 ?
                                              '${double.parse(productList[index].prVarientList![0].price!).toString()+ " "+SysCurrency}'
