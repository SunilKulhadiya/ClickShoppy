...
class GridViewLayOut extends StatefulWidget {
  int index;
  Function update;
  final String sysCurrench;

  GridViewLayOut({
    Key? key,
    required this.index,
    required this.update,
    required this.sysCurrench,
  }) : super(key: key);
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(getTranslated(context, 'CurrentLanguage') == 'English' ?
                      ...
                      context.read<ExploreProvider>().productList[index].motherTongue == null ? "" :
                      context.read<ExploreProvider>().productList[index].motherTongue!,
