...
import 'package:clickshoppy/Provider/Theme.dart';
import 'package:clickshoppy/Screen/Profile/MyProfile.dart';
import 'package:clickshoppy/Screen/ExploreSection/explore.dart';
import 'package:clickshoppy/Screen/PushNotification/PushNotificationService.dart';
import 'package:clickshoppy/cubits/personalConverstationsCubit.dart';
import 'package:clickshoppy/repository/NotificationRepository.dart';
  ...
  _getAppBar() {
    ...
    final appBar = AppBar(
      ...
      title: /* _selBottom == 0
          ? */
          Image.asset(
        DesignConfiguration.setPngPath('ClickShoppy4'),
        height: 40,
      ),
      /* : Text(
              title!,
