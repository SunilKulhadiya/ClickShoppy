...
import 'package:clickshoppy/Provider/Favourite/FavoriteProvider.dart';
...
class SingleProductContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("11111111111111 singleProductContainer.dart, -------------- productDetails : ${productDetails.name}");
    print("222222222222222 singleProductContainer.dart, -------------- productDetails : ${productDetails.motherTongue}");
    if (length > index) {
      String? offPer;
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(getTranslated(context, 'CurrentLanguage') == 'English' ?
                            productDetails.name! : productDetails.motherTongue == null ? "" :
                            productDetails.motherTongue!,
                            style: Theme.of(context)
                                .textTheme
                                .titleSmall!
                                .copyWith(
