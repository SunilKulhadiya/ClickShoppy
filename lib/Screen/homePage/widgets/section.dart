...
import 'package:clickshoppy/Model/Model.dart';
import 'package:clickshoppy/Model/Section_Model.dart';
import 'package:clickshoppy/Provider/homePageProvider.dart';
import 'package:clickshoppy/Screen/Product%20Detail/productDetail.dart';
import 'package:clickshoppy/Screen/ProductList&SectionView/ProductList.dart';
import 'package:clickshoppy/Screen/ProductList&SectionView/SectionList.dart';
import 'package:clickshoppy/Screen/SubCategory/SubCategory.dart';
import 'package:clickshoppy/Screen/homePage/widgets/offerImage.dart';
import 'package:clickshoppy/Screen/homePage/widgets/singleProductContainer.dart';
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return SingleSection(
                      index: index,
                      from: 1,
                      sectionTitle: getTranslated(context, 'CurrentLanguage') == 'English' ? context
                      ...
                      sectionStyle: context
                              ...
                              .style ??
                          '',
                      sectionSubTitle: getTranslated(context, 'CurrentLanguage') == 'English' ?
                              context.read<HomePageProvider>()
                              .sectionList[index]
                              .shortDesc ?? '' : context.read<HomePageProvider>()
                          .sectionList[index]
                          .shortDesc == null ? "" : context.read<HomePageProvider>()
                          .sectionList[index]
                          .shortDesc_MT ?? '',
                      productList: context
                              .read<HomePageProvider>()
