...
import 'package:clickshoppy/Screen/Auth/Set_Password.dart';
import 'package:clickshoppy/Screen/Auth/SignUp.dart';
import 'package:clickshoppy/cubits/appSettingsCubit.dart';
import 'package:clickshoppy/repository/authRepository.dart';
...
class _MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      print("************-----------Verify otp, isSMSGatewayOn : ${isSMSGatewayOn}");
      if (!isSMSGatewayOn) {
        _onVerifyCode();
      } else {
        isCodeSent = true;
  ...
  Future<void> getSingature() async {
    ...
    print("------------------------Verify_Otp.dart, 95 signature : ${signature}");
  }
