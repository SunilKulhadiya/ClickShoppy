...
const String appName = 'Click Shoppy';
const String PckgName = 'ClickShoppy';

//please add your panel's API base URL here (you can find from settings->client APIs)
const String baseUrl = "https://sixads.in/ClickShoppy/app/v1/api/";
const String chatBaseUrl = 'https://sixads.in/ClickShoppy/app/v1/Chat_Api/';

//for codecanyon demo app only, don't change it
const bool isDemoApp = false;

//Your package name
const String packageName = 'com.websutility_clickshoppy.customer';
...
const String deepLinkName = 'clickshopy.com';
